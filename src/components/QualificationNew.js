...
import {Grid,Typography,Box,Button,Stack,TextField,Alert,Snackbar,Divider} from '@mui/material';
...
//Common Functions For All
 ...
 if(degree.length<5){
  ...
  instance.post('qualification',data)
    .then((response)=> {
      setAlertShow(true);
 ...
 const resetForm=()=>{
  ...
  return (
      ...
      <Typography align={'center'} variant={'h6'} sx={{marginBottom:2}}>Add Qualification Details</Typography>
      <Typography sx={{textAlign:'center',marginBottom:7}}>You Can Add Maximum 4 Qualification Details</Typography>
